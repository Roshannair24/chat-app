...
export default function ChatWindow() {
  ...
  const initContent =
    "Hi! I'm your ABC Motors assistant. Looking for pricing, a test drive, or checking on an existing order?";
        ...
        {loading && (
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div
              style={{
                background: "#FCEFE7",
                border: "1px solid #F0D3BE",
                borderRadius: 999,
                padding: "6px 14px",
              }}
            >
              <span style={{ fontSize: 12, color: "#B4501E" }}>
                ⚙ Thinking…
              </span>
            </div>
          </div>
